...
execute as @s[tag=custrees_modest.marker.azalea] at @s if block ~ ~ ~ oak_log unless entity @s[type=item,nbt={Item:{id:"minecraft:flowering_azalea",count:1},Age:0s},distance=..2] run function custrees_modest:tree/grow/azalea

execute as @s[tag=custrees_modest.marker.brown_mushroom] at @s if block ~ ~ ~ mushroom_stem unless entity @s[type=item,nbt={Item:{id:"minecraft:brown_mushroom",count:1},Age:0s},distance=..2] run function custrees_modest:tree/grow/mushroom/brown/init
execute as @s[tag=custrees_modest.marker.red_mushroom] at @s if block ~ ~ ~ mushroom_stem unless entity @s[type=item,nbt={Item:{id:"minecraft:red_mushroom",count:1},Age:0s},distance=..2] run function custrees_modest:tree/grow/mushroom/red/init

execute as @s[tag=custrees_modest.marker.blue_nether] at @s if block ~ ~ ~ warped_stem unless entity @s[type=item,nbt={Item:{id:"minecraft:warped_fungus",count:1},Age:0s},distance=..2] run function custrees_modest:tree/grow/nether_tree/blue/init
execute as @s[tag=custrees_modest.marker.red_nether] at @s if block ~ ~ ~ crimson_stem unless entity @s[type=item,nbt={Item:{id:"minecraft:crimson_fungus",count:1},Age:0s},distance=..2] run function custrees_modest:tree/grow/nether_tree/red/init
